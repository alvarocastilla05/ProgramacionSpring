...
/**
 * Como ya se ha visto, esta clase está anotada con @RequestMapping, que significa que todas 
 * las peticiones que atiendan los métodos de dentro, 
 * tendrán la ruta /admin/categoria/lo que sea. Con esto, en los getMapping o PostMapping 
 * de los métodos no tenemos que escribir de nuevo toda parte común, admin/categoria 
 * sino que solo escribimos 
...
public class CategoriaController {
	 ...
	 * de la carpeta templates sino que está dentro de una subcarpeta llamada admin, 
	 * debemos escribir eso la ruta en el return y por eso, 
	 ...
	 * 				<div class="pull-right">
		...
		se añade al modelo una nueva categoría (vacía porque es un formulario de "alta" 
	 ...
	 * 
	 * Añadimos ese parámetro con @ModelAttribute 
	 ...
	 * 
	 * Dentro del método, llamamos a save para que 
	 ...
	 * lista "actualizada". Debemos ir primero al controlador que muestra la lista de 
	...
	public String submitNuevaCategoria(@ModelAttribute("categoria") Categoria categoria, Model model) {
		...
		//no podemos ahorrar la parte inicial
	 ...
	 * 
	 * Si te fijas, el th:href al pulsar el botón editar, 
	 ...
	 * pinchada/elegida para editar. Las llaves significan que es un parámetro y los paréntesis 
	 ...
	 * y es del tipo Long
	 * 
	 * Ojo, la búsqueda con findById debería devolver un Optional, como hemos visto en casos anteriores
	 * y no una categoría o null.
	 * 
	 ...
	 * @PathVariable
	 * 
	 * Buscamos la categoría (de nuevo habría que cambiar el findByIdy para que devuelva 
	 * un Optional) y si la encontramos (es distinta de null), 
	 * comprobamos que no tenga productos (si tiene productos no 
	 * sería buena idea borrarla porque ¿en qué categoría quedarían dichos productos? 
	 * 
	 * En ese caso, agregaríamos el parámetro error como true a la ruta
	 * lo que mostrará según el html un mensaje y si no tiene productos asociados, 
	 * se borra la categoría con delete.
	 * 
	 * Para ver el número de productos que tiene una categoría, usamos un método del 
